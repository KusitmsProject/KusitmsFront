...
extension byEmoResult {
    static var emotions: [byEmoResult] = [
        byEmoResult(date: "2022-11-12", postIdx: 18, musicIdx: 4, artist: "Day6", track: "예뻤어", lyrics: "지금 이 말이\n우리가 다시\n시작하자는 건 아냐\n그저 너의\n", emotion: "HAPPY", videoId: "BS7tz2rAOSA", options: 0),
        byEmoResult(date: "2022-11-12", postIdx: 2, musicIdx: 3, artist: "BTS", track: "Dynamite", lyrics: "'Cause I, I, I\'m in the stars tonight\nSo, watch me bring the fire, and set the night alight\nYour shoes on, get up in the morn\'\nCup of milk, let\'s rock \'n\' roll\n", emotion: "LOVELY", videoId: "gdZLi9oWNZg", options: 1),
        byEmoResult(date: "2022-11-12", postIdx: 36, musicIdx: 4, artist: "Day6", track: "예뻤어", lyrics: "지금 이 말이\n우리가 다시\n시작하자는 건 아냐\n그저 너의\n", emotion: "ANGRY", videoId: "BS7tz2rAOSA", options: 0),
        byEmoResult(date: "2022-11-12", postIdx: 13, musicIdx: 5, artist: "Day6", track: "Congratulations", lyrics: "이제는 연락조차 받질 않아\n너 대신 들리는 무미건조한 목소리\n힘든 날들도 있는 건데\n잠깐을 못 이겨 또 다른 대안을 찾아가\n", emotion: "SAD", videoId: "BS7tz2rAOSA", options: 1),
        byEmoResult(date: "2022-11-12", postIdx: 37, musicIdx: 4, artist: "Day6", track: "예뻤어", lyrics: "지금 이 말이\n우리가 다시\n시작하자는 건 아냐\n그저 너의\n", emotion: "EXPLODE", videoId: "BS7tz2rAOSA", options: 1),
        byEmoResult(date: "2022-11-11", postIdx: 6, musicIdx: 1, artist: "blackpink", track: "붐바야", lyrics: "BLACKPINK in your area\nBLACKPINK in your area\nBeen a bad girl, I know I am\nAnd I\'m so hot, I need a fan\n", emotion: "TIRED", videoId: "3ERtNZqh1XA", options: 0)
