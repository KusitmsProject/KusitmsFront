...
extension ResultBySong {
    ...
    ResultBySong(date: "2022-11-26", postIdx: 9, musicIdx: 5, videoID: "x3sFsHrUyLQ", artist: "Day6", track: "Congratulations", lyrics: "null이제는 연락조차 받질 않아\n너 대신 들리는 무미건조한 목소리\n힘든 날들도 있는 건데\n잠깐을 못 이겨 또 다른 대안을 찾아가\n", emotion: "HAPPY", options: 1),
    ...
    static var diffpostings: [ResultBySong] = [ResultBySong(date: "2022-11-15", postIdx: 13, musicIdx: 5, videoID: "x3sFsHrUyLQ", artist: "Day6", track: "Congratulations", lyrics: "null이제는 연락조차 받질 않아\n너 대신 들리는 무미건조한 목소리\n힘든 날들도 있는 건데\n잠깐을 못 이겨 또 다른 대안을 찾아가\n", emotion: "SAD", options: 1),
    ResultBySong(date: "2022-11-10", postIdx: 13, musicIdx: 5, videoID: "x3sFsHrUyLQ", artist: "Day6", track: "Congratulations", lyrics: "null이제는 연락조차 받질 않아\n너 대신 들리는 무미건조한 목소리\n힘든 날들도 있는 건데\n잠깐을 못 이겨 또 다른 대안을 찾아가\n", emotion: "SAD", options: 1),
